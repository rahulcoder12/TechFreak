...
const CheckoutForm = () => {
  ...
  async function handleSubmit(e) {
    ...
    const result = await stripe.confirmPayment({
      elements,
      confirmParams: {
        // FIX: Dynamically grabs localhost or your vercel domain so it always routes back correctly!
        return_url: `${window.location.origin}/payment_success?id=${data.paymentIntent.metadata.productId}`,
      },
...
// FIX: Removed backticks and perfectly matched the .env variable name
...
export default function PaymentRoute() {
  ...
  // FIX: Safely pass the client secret without string wrapping
  const options = {
      ...
      <section className="section-payment">
        <div className="section-payment__container">
          ...
          <div className="section-payment__payment">
            ...
            {/* The Elements provider only mounts if a clientSecret exists, preventing crashes */}
